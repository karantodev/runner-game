...
export const PROP_METRICS = new Map([
  ...
  [ASSETS.mushroom, [1.35, 0.82, 0.28]],
  [ASSETS.fence, [0.60, 2.0, 0.18]],
  [ASSETS.bush, [0.55, 1.7, 0.14]],
  [ASSETS.grassBlock, [1.25, 1.15, 0.10]],
  [ASSETS.grassBlockLeft, [1.25, 1.15, 0.10]],
  [ASSETS.grassBlockRight, [1.25, 1.15, 0.10]],
  [ASSETS.grassPlatform, [0.7, 2.3, 0.12]],
  [ASSETS.purpleBrick, [0.75, 1.4, 0.10]],
  [ASSETS.purpleWall, [0.85, 1.5, 0.10]],
  [ASSETS.purpleStairs, [0.85, 1.55, 0.10]],
  [ASSETS.questionBlock, [0.88, 1.0, 0.18]],
